    ...
    while True:
        ...
        with engine.connect() as connection:
            ...
            for row in pin_selected_row:
                ...
                print('pin result mapped')

                invoke_url_pin = "https://rryghwc4f6.execute-api.us-east-1.amazonaws.com/test/topics/1282968b0e7f.pin"
                ...
                print('payload variable created')
            ...
            for row in geo_selected_row:
                ...
                print('geo result mapped')
                
                invoke_url_geo = "https://rryghwc4f6.execute-api.us-east-1.amazonaws.com/test/topics/1282968b0e7f.geo"
                ...
                print(response.status_code)
                print('geo response code printed')
            ...
            for row in user_selected_row:
                ...
                print('user result mapped')            
  
                invoke_url_user = "https://rryghwc4f6.execute-api.us-east-1.amazonaws.com/test/topics/1282968b0e7f.user"
